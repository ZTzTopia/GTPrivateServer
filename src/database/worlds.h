...
namespace database {
    ...
    struct Worlds : sqlpp::table_t<Worlds, worlds_::Name, worlds_::CreatedAt, worlds_::UpdatedAt, worlds_::Width, worlds_::Height, worlds_::DecompressedSizeData, worlds_::CompressedSizeData, worlds_::Data> {
        struct _alias_t {
