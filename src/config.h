...
namespace config {
    ...
    namespace server_game {
        ...
        constexpr auto port = server_gateway::port - server_game::count;
        constexpr auto max_peer = 32;
    }
    ...
    namespace on_super_main {
        ...
        constexpr std::string_view param5 = "proto=158|choosemusic=audio/mp3/about_theme.mp3|active_holiday=2|wing_week_day=0|ubi_week_day=0|server_tick=18872208|clash_active=0|drop_lavacheck_faster=1|isPayingUser=0|usingStoreNavigation=1|enableInventoryTab=1|bigBackpack=1|";
    }
