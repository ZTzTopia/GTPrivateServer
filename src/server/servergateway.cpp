...
//                m_load_balancer->remove_server(server);
//                continue;
//            }
//
//            m_load_balancer->add_server(server);
//        }
//
//        Server *best_server = m_load_balancer->get_server_with_minimum_player();
//        if (best_server) {
